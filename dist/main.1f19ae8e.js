...
var pd_andy$elm_web_audio$WebAudio$Property$encodeScheduledUpdateValue = function (_n0) {
...
var pd_andy$elm_web_audio$WebAudio$osc = pd_andy$elm_web_audio$WebAudio$oscillator;
	...
	return author$project$Main$updateAudio(
		pd_andy$elm_web_audio$WebAudio$encodeGraph(
			_List_fromArray(
				[
					A2(
					pd_andy$elm_web_audio$WebAudio$osc,
					_List_fromArray(
						[
							pd_andy$elm_web_audio$WebAudio$Property$frequency(model.freq)
						]),
					_List_fromArray(
						[
							A2(
...
var author$project$Main$init = function (context) {
	var model = A2(author$project$Main$Model, context, 0);
	return _Utils_Tuple2(
		model,
		author$project$Main$audio(model));
};
...
_Platform_export({'Main':{'init':author$project$Main$main(elm$json$Json$Decode$value)({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"NoOp":[],"MouseMove":["Basics.Float"]}},"Basics.Float":{"args":[],"tags":{"Float":[]}}}}})}});
...
},{}],"js/virtual-audio.js":[function(require,module,exports) {
"use strict";
...
/*#__PURE__*/
function () {
  _createClass(VirtualAudioGraph, null, [{
    key: "prepare",
    // Static Methods ============================================================
    //
    ...
    value: function diff(oldNodes, newNodes) {
      ...
      for (var _i = 0, _Object$values = Object.values(newNodes); _i < _Object$values.length; _i++) {
        _loop();
      }

      for (var _i2 = 0, _Object$values2 = Object.values(oldNodes); _i2 < _Object$values2.length; _i2++) {
        var oldNode = _Object$values2[_i2];
        patches.removed.push({
          type: 'node',
          key: oldNode.key,
          data: oldNode
...
var _virtualAudio = _interopRequireDefault(require("./js/virtual-audio"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var context = new (AudioContext || webkit.AudioContext)(); // These days, an audio context starts in a suspended state and must be 
...
var audio = new _virtualAudio.default(context);
...
},{"./elm/Main.elm":"elm/Main.elm","./js/virtual-audio":"js/virtual-audio.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
